#!/bin/bash
# Backend EC2 instance setup script for Amazon Linux 2
...
# Clone application repository (in a real scenario)
# git clone https://github.com/yourusername/4-tier-app.git .

# Create application files manually (for demo purposes)
cat > app.js << 'EOL'
...
try {
  redisClient = new Redis({
    ...
    // Added TLS support for Redis (recommended for production)
...
{
  "name": "4-tier-app-backend",
  "version": "1.0.0",
  "description": "Backend service for 4-tier application",
  "main": "app.js",
  "scripts": {
    "start": "node app.js",
    "dev": "nodemon app.js",
...
cat > /opt/myapp/health-check.sh << 'EOL'
#!/bin/bash
...
echo "Backend setup on Amazon Linux completed successfully!"
